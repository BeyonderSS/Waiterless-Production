...
export default function NotAuth() {
  return (
	...
	<div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
		...
		<p className="text-3xl">You are Not Authorized </p>
		<div rel="noopener noreferrer" className="px-8 py-3 font-semibold rounded bg-orange-400 text-gray-900">Please Scan The QR Again</div>
	</div>
</section>
  )
}